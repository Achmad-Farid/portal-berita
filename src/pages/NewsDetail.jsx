...
function NewsDetail() {
  return (
    <div className="container mx-auto px-4 py-8">
      <Helmet>
        <title>Judul</title>
        <meta name="description" content="Deskripsi artikel untuk SEO" />
        <meta name="keywords" content="berita, artikel, informasi" />
      </Helmet>

      <header className="mb-8">
        <h1 className="text-4xl font-heading text-secondary mb-4">Judul</h1>
        <p className="text-gray">Tanggal Publikasi: 12 September 2024</p>
      </header>
      ...
      <section className="mb-8">
        ...
        <p className="text-lg text-neutral-dark leading-relaxed mb-4">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sunt ad beatae atque officiis quia totam voluptas dolor consectetur molestiae dolorum!</p>
      </section>
      ...
      <footer className="border-t pt-6 mt-8">
        <p className="text-gray">Ditulis oleh: Penulis</p>
      </footer>
    </div>
  );
}
